...
public class MathTricksTest
{
    ...
    public void testSoftmax_doubleArr_boolean()
    {
        ...
        double[] xExpected = {0.6652409557748218895, 0.090030573170380457998, 0.24472847105479765};
        double[] x2Expected = {0.64391425988797231, 0.087144318742032567489, 0.23688281808991013};
    ...
    {
        System.out.println("softmax");
        Vec x = DenseVector.a(new double[]{3, 1, 2});
        Vec x2 = x.clone();
        
        Vec xExpected = DenseVector.a(new double[]{0.6652409557748218895, 0.090030573170380457998, 0.24472847105479765});
        Vec x2Expected = DenseVector.a(new double[]{0.64391425988797231, 0.087144318742032567489, 0.23688281808991013});
